...
const intro = new Discord.MessageEmbed()
 ...
 const usefulLinks = new Discord.MessageEmbed()
	.setColor('#0000ff')
...
const GameID = new Discord.MessageEmbed()
	.setColor('#0000ff')
...
const nextCup = new Discord.MessageEmbed()
	.setColor('#0000ff')
...
const Brackets = new Discord.MessageEmbed()
	.setColor('#0000ff')
...
const LeaveTeam = new Discord.MessageEmbed()
	.setColor('#0000ff')
...
const TeamPermissions = new Discord.MessageEmbed()
	.setColor('#0000ff')
...
const CupDuration = new Discord.MessageEmbed()
	.setColor('#0000ff')
...
const TechnicalIssues = new Discord.MessageEmbed()
	.setColor('#0000ff')
...
const PlayerIssues = new Discord.MessageEmbed()
	.setColor('#0000ff')
...
const NoShow = new Discord.MessageEmbed()
	.setColor('#0000ff')
...
const NewTeam = new Discord.MessageEmbed()
	.setColor('#0000ff')
...
const Money = new Discord.MessageEmbed()
    ...
    if (message.member.roles.cache.has(roleList.get("esh"))) {
